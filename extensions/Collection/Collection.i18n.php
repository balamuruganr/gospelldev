...
$messages['en'] = array(
	...
	'coll-start_book_creator'         => 'Start book creator', //Start book creator
...
$messages['arc'] = array(
	...
	'coll-rendering_article' => '(ܦܐܬܐ ܕܘܝܩܝ: $1)',
	'coll-rendering_page' => '(ܦܐܬܐ: $1)',
...
$messages['ba'] = array(
	...
	'coll-book_creator_intro' => "<big>''Китап оҫтаһы'' ярҙамында Һеҙ һайлаған вики-биттәрҙән китап яһай алаһығыҙ. Китапты төрлө форматта сығара (мәҫәлән, PDF йәки ODF) йәки баҫма нөсхәһән һората алаһығыҙ.</big>",
	...
	'coll-start_book_creator' => 'Китап оҫтаһын ҡуллана башларға',
	'coll-book_creator_continue' => 'Китап оҫтаһын ҡулланыуҙы дауам итергә',
	'coll-book_creator_disable_text' => 'Китап оҫтаһы ябыласаҡ һәм һеҙ яһай башлаған китап юйыласаҡ.',
...
JavaScript ғәмәлдә булмаған саҡта был бит дөрөҫ эшләмәйәсәк.</strong>',
	...
	'coll-move_up' => 'Өҫкәрәк күсерергә',
	'coll-move_down' => 'Аҫҡараҡ күсерергә',
	'coll-move_to_bottom' => 'Иң аҫҡа күсерергә',
	'coll-title' => 'Башлыҡ:',
	'coll-subtitle' => 'Өҫтәмә исем:',
	'coll-contents' => 'Йөкмәткеһе',
	...
	'coll-sort_alphabetically' => 'Алфавит буйынса тәртипкә килтерергә',
	...
	'coll-save_collection_title' => 'Китапты һаҡларға һәм уртаҡлашырға',
	'coll-save_collection_text' => 'Китабығыҙҙы һаҡлау өсөн урын һайлағыҙ:',
	'coll-login_to_save' => 'Китапты артабан ҡулланыу маҡсатында һаҡлар өсөн, зинһар, [[Special:UserLogin|сайтта теркәлегеҙ йәки иҫәп яҙмаһын булдырығыҙ]].',
	...
	'coll-overwrite_title' => 'Бит бар. Өҫтөнә яҙырғамы?',
	'coll-overwrite_text' => '[[:$1]] исемле бит бар инде.
Уның китабығыҙҙа алыштырылыуын теләйһегеҙме?',
	'coll-yes' => 'Эйе',
	'coll-no' => 'Юҡ',
	'coll-load_overwrite_text' => 'Һеҙҙең китабығыҙҙа бер нисә бит бар инде.
Һеҙ ағымдағы китапты яңынан яҙҙырырға, яңы эстәлек өҫтәргә йәки был китапты тейәүҙе кире алырға теләйһегеҙме?',
	'coll-overwrite' => 'Яңынан яҙҙырырға',
	'coll-append' => 'Өҫтәргә',
	'coll-cancel' => 'Кире алырға',
	'coll-update' => 'Яңыртырға',
	'coll-limit_exceeded_title' => 'Китап бик ҙур',
	'coll-limit_exceeded_text' => 'Китабығыҙ бигерәк ҙур.
...
Әгәр яңырмаһа, зинһар, браузерығыҙҙың "Яңыртыу" төймәһенә баҫығыҙ.</p>',
	...
	'coll-rendering_finished_title' => 'Яһау тамамланды',
...
* Һөҙөмтә менән ҡәнәғәт түгелһегеҙме? Яҡшыртыу мөмкинлектәре тураһында [[{{MediaWiki:Coll-helppage}}|китаптар тураһында белешмә битендә]] уҡығыҙ.',
	...
	'coll-download_notfound_text' => 'Һеҙ күсереп алырға теләгән файл юҡ. Ихтимал, ул юйылған, һәм уны тергеҙергә кәрәк.',
	'coll-download_failed_title' => 'Күсереп алыу ваҡытында хата',
	'coll-download_failed_text' => '$1 файлын күсереп алыу ваҡытында хата килеп сыҡты',
	'coll-is_cached' => '<ul><li> Был документтың кэшланған өлгөһө табылды, төшөрөү талап ителмәне. <a href="$1">Яңынан төшөрөргә.</a></li></ul>',
...
Был исемлек һеҙ өҫтәү йәки юйыу төймәләренә баҫҡан һайын яңыра.',
	...
	'coll-suggest_reset_bans' => 'таҙартырға',
	...
	'coll-format-rl' => 'эл. китап (PDF)',
	'coll-format-epub' => 'эл. китап (EPUB)',
	'coll-format-odf' => 'текст процессоры (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
Listen opdateres når du klikker på tilføj- eller fjernknapperne.',
	...
	'coll-format-rl' => 'e-bog (PDF)',
	'coll-format-epub' => 'e-bog (EPUB)',
	'coll-format-odf' => 'tekstbehandling (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
Çi wext ti gocakanê de kerdişî u wedarayîşî ra klik bike, liste beno rocaniye.',
	...
	'coll-suggest_ban_tooltip' => 'Ena pele lista weşenayışan ra wedare',
	...
	'coll-format-rl' => 'e-kıtab (PDF)',
	'coll-format-epub' => 'e-kıtab (EPUB)',
	'coll-format-odf' => 'emeliya çekuye (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DokumanKıtabe',
	'coll-format-okawix_zeno' => 'Okawix',
...
لطفاً با مدیر مدیاویکی خود تماس بگیرید.',
	...
	'coll-suggest_title' => 'صفحه‌های پیشنهادی برای کتابتان',
	'coll-suggest_intro_text' => 'پیشنهادها بر پایهٔ مجموعهٔ کنونی صفحه‌های ویکی در کتاب شما قرار دارند.
هر گاه که بر دکمه‌های افزودن یا حذف کلیک کنید، فهرست به‌روز خواهد شد.',
	...
	'coll-suggest_ban_tooltip' => 'این صفحه را از فهرست پیشنهادها حذف کنید',
	'coll-suggest_article_ban' => 'صفحهٔ <strong>$1</strong> از پیشنهادها حذف شده است ($2).',
...
La liste est mise à jour à chaque fois que vous cliquez sur les boutons d'ajout ou de suppression.",
	...
	'coll-format-rl' => 'e-book (PDF)',
	'coll-format-epub' => 'e-book (EPUB)',
	'coll-format-odf' => 'traitement de texte (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
La lista est betâ a jorn a châque côp que vos clicâd sur los botons d’aponsa ou ben de suprèssion.',
	...
	'coll-format-rl' => 'lévro èlèctronico (PDF)',
	'coll-format-epub' => 'lévro èlèctronico (EPUB)',
	'coll-format-odf' => 'trètament de tèxto (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
Wan dü wat diartuskrafst of wechnamst, woort det list nei maaget.',
	...
	'coll-format-rl' => 'e-book (PDF)',
	'coll-format-epub' => 'e-book (EPUB)',
	'coll-format-odf' => 'tekst bewerker (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
Le lista es actualisate cata vice que tu clicca super le buttones "adder" o "remover".',
	...
	'coll-format-rl' => 'libro electronic (PDF)',
	'coll-format-epub' => 'libro electronic (EPUB)',
	'coll-format-odf' => 'processor de texto (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
$messages['is'] = array(
	...
	'coll-print_template_prefix' => 'Prenta',
	'coll-print_template_pattern' => '$1/Prenta',
	'coll-unknown_subpage_title' => 'Óþekkt undirsíða',
	'coll-unknown_subpage_text' => 'Þessi undirsíða [[Special:Book|bókar]] er ekki til',
	'coll-couldnotaddarticle_title' => 'Mistókst að bæta við wiki síðu',
	'coll-couldnotaddarticle_msg' => 'Ekki var hægt að bæta við wiki síðunni.',
	'coll-couldnotremovearticle_title' => 'Mistókst að fjarlægja wiki síðu',
	'coll-couldnotremovearticle_msg' => 'Ekki var hægt að fjarlægja wiki síðuna.',
	'coll-noscript_text' => '<h1>JavaScript er krafist!</h1>
<strong>Vafrarinn þinn annaðhvort styður ekki JavaScript eða hefur slökkt á JavaScript.
Síðan mun ekki virka rétt, nema JavaScript verði virkjað.</strong>',
	'coll-savedbook_template' => 'vistuð_bók',
	'coll-your_book' => 'Bókin þín',
	'coll-download_title' => 'Hlaða niður',
	'coll-download_text' => 'Til þess að hlaða niður bókinni þinni, veldu skráarsnið og smelltu á takkann.',
	'coll-download_as_text' => 'Til þess að hlaða inn bókinni þinni á $1 skráarsniði ýttu á takkann.',
	'coll-download' => 'Hlaða niður',
	...
	'coll-drag_and_drop' => 'Nota draga og sleppa til að endurraða wiki síðum og köflum',
	'coll-create_chapter' => 'Búa til kafla',
	'coll-sort_alphabetically' => 'Raða í stafrófsröð',
	...
	'coll-save_collection_title' => 'Vista og deila bókinni þinni',
...
Yfirskrifa?',
	'coll-overwrite_text' => 'Síða með titlinum [[:$1]] er þegar til.
Vilt þú skipta henni út fyrir bókina þína?',
	'coll-yes' => 'Já',
	'coll-no' => 'Nei',
	'coll-load_overwrite_text' => 'Þú hefur nú þegar síður í bókinni þinni.
Viltu yfirskrifa núverandi bók, bæta við nýju efni eða hætta við að hlaða þessari bók?',
	'coll-overwrite' => 'Yfirrita',
	'coll-append' => 'Auka við',
	'coll-cancel' => 'Hætta við',
	'coll-update' => 'Uppfæra',
	'coll-limit_exceeded_title' => 'Bókin er of stór',
...
* Ertu óánægður með útkomuna? Skoðaðu [[{{MediaWiki:Coll-helppage}}|hjálparsíðuna um bækur]] fyrir möguleika til þess að bæta hana.',
	...
	'coll-download_notfound_text' => 'Skráin sem þú ert að reyna að hlaða niður er ekki til:
...
<a href="$1">Neyða endurskrifun.</a></li></ul>',
	...
	'coll-book_title' => 'Panta prentaða bók',
	'coll-book_text' => 'Fá prentaða bók frá samstarfsaðila okkar sem prentar eftir þörfum.',
	'coll-order_from_pp' => 'Forskoða með $1',
	'coll-about_pp' => 'Um $1',
	'coll-invalid_podpartner_title' => 'Ógildur POD-samstarfsaðili',
	'coll-invalid_podpartner_msg' => 'POD samstarfsaðili er ógildur.
Vinsamlegast hafðu samband við stjórnanda.',
	'coll-license' => 'Leyfi',
...
Listinn er uppfærður þegar þú ýtir á bæta við eða fjarlægja takkann.',
	...
	'coll-suggest_reset_bans' => 'endursetja',
	'coll-suggest_reset_bans_tooltip' => 'Sýna fyrrum fjarlægðar uppástungur',
	'coll-suggest_add_selected' => 'Bæta við völdum síðum',
	'coll-suggest_ban_selected' => 'Fjarlægja valdar síður',
	'coll-suggest_your_book' => 'Bókin þín',
	'coll-suggest_show' => 'sýna',
	'coll-suggest_ban_tooltip' => 'Fjarlægja þessa síðu frá uppástungu listanum',
	'coll-suggest_article_ban' => 'Síðan <strong>$1</strong> var fjarlægð úr uppástungum ($2).',
	'coll-suggest_article_add' => 'Síðunni <strong>$1</strong> var bætt við bókina þína ($2).',
	'coll-suggest_article_remove' => 'Síðan <strong>$1</strong> var fjarlægð úr bókinni þinni ($2).',
	'coll-suggest_undo_tooltip' => 'Taka aftur þessa breytingu',
	'coll-suggest_undo' => 'Taka aftur',
...
Çi wext ti gocakanê de kerdişî u wedarayîşî ra klik bike, liste beno rocaniye.',
	...
	'coll-suggest_undo' => 'reyna biyar',
	'coll-load_local_book' => 'OK rê bitexne ke ti kitabê xo %TITLE% de %NUMPAGES% pelanê wikiyi esta ay de dewam bike. Cancel ra bitexne ke wedarne u yew kitabê newi ra dest pê bike.',
	'coll-format-rl' => 'e-kıtabe (PDF)',
	'coll-format-epub' => 'e-kıtabe (EPUB)',
	'coll-format-odf' => 'İtimade çekuye (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DokumanKıtabe',
	'coll-format-okawix_zeno' => 'Okawix',
	'right-collectionsaveasuserpage' => 'Kitab ze pelê karberî qeyd bike',
...
$messages['kk-cyrl'] = array(
	...
	'coll-exclusion_category_title' => '{{SITENAME}}:Баспадан шығару',
...
<strong>Компьютеріңізге [$1 жүктеп алу сілтемесі]</strong>.
...
Бәлкім, ол жойылған болар және де оны қайта жасау керек шығар.',
	...
	'coll-excluded-templates' => '* «[[:Category:$1|$1]]» санатындағы үлгілер аласталды.',
	...
	'coll-book_text' => 'Бiздiң әрiптесімізден кітаптың баспа нұсқасына тапсырыс беру.',
...
추가 또는 제거 버튼을 누를 때마다 목록이 업데이트됩니다.',
	...
	'coll-format-rl' => '전자책 (PDF)',
	'coll-format-epub' => '전자책 (EPUB)',
	'coll-format-odf' => '워드 프로세서 (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
Dës Säit fonctionnéiert net richteg, ausser wa JavaScript ageschalt ass</strong>',
	...
	'coll-sort_alphabetically' => 'Alphabetesch zortéieren',
 ...
 */
$messages['mdf'] = array(
	'coll-desc' => '[[Special:Book|Тиемс китап]]',
	'coll-book_creator_intro' => "<big>''Китапонь тиемать'' вельде тейть ули кода тиемс китап кочкаф вики лопаста. Китапсь ули кода экспортыяфтомс эрь кодама форматс (кепотоксонди PDF эли ODF) эли сявондемс принтыяфтф нолдафкс.</big>",
	'coll-manage_your_book' => 'Азорондамс китапсот',
	'coll-book_creator_help' => 'Ванк [[{{MediaWiki:Coll-helppage}}|китапонь коряс лездома лопат]] сяда тов информациенкса.',
	'coll-start_book_creator' => 'Нодамс китапонь тиемать',
	'coll-book_creator_continue' => 'Покамс китапонь тиемать мархта сяда тов',
	'coll-book_creator_disable_text' => "''Китапонь тиемать'' лоткафтсазь, китапть, конань тиендеть нардасазь.",
	'coll-book_creator_text_article' => '{{MediaWiki:Coll-helppage}}/Китапонь тиемать текстоц',
	'coll-collection' => 'Китап',
	'coll-collections' => 'Китапт',
	'coll-exclusion_category_title' => 'Нардамс принтыяфтомаста',
	'coll-print_template_prefix' => 'Принтыяфтомс',
	'coll-print_template_pattern' => '$1/Принтыяфтомс',
	'coll-unknown_subpage_title' => 'Аф содаф сублопа',
	'coll-unknown_subpage_text' => '[[Special:Book|Китапть]] стама сублопац аш',
	'coll-couldnotaddarticle_title' => 'Вики лопась аф поладови',
	'coll-couldnotaddarticle_msg' => 'Вики лопать аш кода поладомс',
	'coll-couldnotremovearticle_title' => 'Вики лопась аф нардави',
	'coll-couldnotremovearticle_msg' => 'Вики лопать аш кода нардамс.',
	'coll-noscript_text' => '<h1>Веши JavaScript!</h1>
<strong>Интернетс вятемаце аф кирди JavaScript эли JavaScript лоткаф.
Тя лопась аф кармай няфтевома лац мъзярс JavaScript тевс апак нолдак.</strong>',
	'coll-savedbook_template' => 'ванфтф_китап',
	'coll-your_book' => 'Китапце',
	'coll-download_title' => 'Каямс',
	'coll-download_text' => 'Китапцень каяманди васенда кочкак форматонц, меле люпштак пунять.',
	'coll-download_as_text' => 'Люпштак пунять китапцень $1 форматса каяманди.',
	'coll-download' => 'Каямс',
	'coll-format_label' => 'Форматоц:',
	'coll-remove' => 'Нардамс',
	'coll-show' => 'Няфтемс',
	'coll-move_to_top' => 'Шашфтомс пряти',
	'coll-move_up' => 'Шашфтомс вяри',
	'coll-move_down' => 'Шашфтомс алу',
	'coll-move_to_bottom' => 'Шашфтомс алксти',
	'coll-title' => 'Конякс:',
	'coll-subtitle' => 'Конякс мельгакс:',
	'coll-contents' => 'Потмоц',
	'coll-drag_and_drop' => 'Нолдак тевс drag & drop вики лопань эли пакшень вастснон полафтоманди',
	'coll-create_chapter' => 'Тиемс пакш',
	'coll-sort_alphabetically' => 'Арафнемс алфавитонь коряс',
	'coll-rename' => 'Полафтомс лемонц',
	'coll-new_chapter' => 'Од пакшень лемоц',
	'coll-rename_chapter' => 'Тяштьк пакшень лемонц',
	'coll-no_such_category' => 'Стама категорие аш',
	'coll-notitle_title' => 'Лопать коняксоц аф кемокстави.',
	'coll-post_failed_title' => 'POST вешфксонь эльбятькс',
	'coll-post_failed_msg' => '$1-нди POST вешфксонь эльбятькс ($2).',
	'coll-mwserve_failed_title' => 'Пачфнема серверонь эльбятькс',
	'coll-mwserve_failed_msg' => 'Пачфтема серверса лиссь эльбятькс: <nowiki>$1</nowiki>',
	'coll-error_reponse' => 'Серверста сась эльбятькс',
	'coll-empty_collection' => 'Шава китап',
	'coll-revision' => 'Одкстоптома: $1',
	'coll-save_collection_title' => 'Ванфтомс эди тозиямс китапцень мархта',
	'coll-save_collection_text' => 'Кочкак ванфтома васта китапценди:',
	'coll-login_to_save' => 'Ёрат ванфтомс китапнень эди меле тевс нолдамост - эняльттяма [[Special:UserLogin|сувак эли тик од сёрматфтомацень]].',
	'coll-personal_collection_label' => 'Эсь китапце:',
	'coll-community_collection_label' => 'Пуромксонь китапоц:',
	'coll-save_collection' => 'Ванфтомс китап',
	'coll-save_category' => 'Сембе ванфтфт китапне поладовихть [[:Category:{{MediaWiki:Coll-bookscategory}}|{{МедиаВики:Китапкярьксс}}]].',
	'coll-overwrite_title' => 'Лопась ульсь ни.
Тиемс одукс?',
	'coll-overwrite_text' => 'Лопась [[:$1]] лем мархта ули ни.
Ёрат китапцень сонь вастозонза путомс?',
	'coll-yes' => 'Ина',
	'coll-no' => 'Аф',
	'coll-load_overwrite_text' => 'Тонь улихть ни мъзярошка лопада китапозот. Ёрат одукс тиемс тя пингонь китапть эли лоткафтомс китапть тонгомац?',
	'coll-overwrite' => 'Тиемс одукс',
	'coll-append' => 'Тонгомс',
	'coll-cancel' => 'Валхтомс',
	'coll-update' => 'Одкстоптомс',
	'coll-limit_exceeded_title' => 'Китапсь вельф оцю',
	'coll-limit_exceeded_text' => 'Китапце вельф оцю.
Фкявок лопа поладомс аш кода.',
	'coll-rendering_title' => 'Пачфтема',
	'coll-rendering_text' => '<p><strong>Учт мъзярс документсь тиеви.</strong></p>

<p><strong>Сатома:</strong> <span id="renderingProgress">$1</span>% <span id="renderingStatus">$2</span></p>

<p>Тя лопась эслек одонзай мзярошка секундонь ёткса.
Мъзярда аф няфтеви люпштак интернетс вятемацень "однозама" пунять.</p>',
	'coll-rendering_status' => '<strong>Статус:</strong> $1',
	'coll-rendering_article' => '(вики лопа: $1)',
	'coll-rendering_page' => '(лопа: $1)',
	'coll-rendering_page_info_text_article' => '{{MediaWiki:Coll-helppage}}/Арафнесы лопать текстокс',
	'coll-rendering_collection_info_text_article' => '{{MediaWiki:Coll-helppage}}/Арафнесы кярьксть текстокс',
	'coll-rendering_finished_title' => 'Арафнемась анок',
	'coll-rendering_finished_text' => '<strong>Документонь файлась анок.</strong>
<strong>[$1 Каямс файлать]</strong> тонь содама машинасот.

Мяльтяшкс:
* Аф мялезот кода лиссь? Ванк [[{{MediaWiki:Coll-helppage}}|китапонь коряс лездома лопат]] сяда тов синь цебярьгофтоманди.',
	'coll-finished_page_info_text_article' => '{{MediaWiki:Coll-helppage}}/Арафнесы лопать текстокс',
	'coll-finished_collection_info_text_article' => '{{MediaWiki:Coll-helppage}}/Арафнесы кярьксть текстокс',
	'coll-notfound_title' => 'Китапсь апак мук',
	'coll-notfound_text' => 'Китапонь лопац апак мук',
	'coll-download_notfound_title' => 'Файлась апак мук',
	'coll-download_notfound_text' => 'Фалась, кона тяряфтат каямс тя пингть аш:
Шять сон нардафоль эди тяни эряви одукс тиемонза.',
	'coll-download_failed_title' => 'Каямань пингть лиссь эльбятькс',
	'coll-download_failed_text' => 'Файлань каямань пингть лиссь эльбятькс: $1',
	'coll-is_cached' => '<ul><li>Эслек ванфневи файлатнень ётксост мувсь документонь верзиец, сяс од арафнемац аф эрявкстсь.
<a href="$1">Вихца арафнемац.</a></li></ul>',
	'coll-excluded-templates' => '* Шаблотт [[:Category:$1|$1]] категориеса аф нолдафт.',
	'coll-blacklisted-templates' => '* Шаблотт Равжа Лувста [[:$1]] аф нолдафт.',
	'coll-return_to_collection' => '<p>Мърдамс<a href="$1">$2</a>ти</p>',
	'coll-book_title' => 'Сявондемс принтыяфтф китап',
	'coll-book_text' => 'Сявондемс принтыяфтф китап print-on-demand ётка якайста.',
	'coll-order_from_pp' => 'Васень няфтема $1 мархта',
	'coll-about_pp' => '$1 колга',
	'coll-invalid_podpartner_title' => 'Аф кондясти POD ётка якайсь',
	'coll-invalid_podpartner_msg' => 'Кирдеви POD ётка якай аф кондясти.
Кучт пачфтема МедиВики админонди.',
	'coll-license' => 'Лицензие',
	'coll-return_to' => 'Мърдамс [[:$1]]ти',
	'coll-order_info_article' => '{{MediaWiki:Coll-helppage}}/PediaPress китапонь сявондема информациесь',
	'coll-suggest_title' => 'Китапценди кочкаф лопат',
	'coll-suggest_intro_text' => 'Кочкамась тифт тя пингонь китапцень вики лопанзон коряс.
Лувомась одонзай кодак аньцек люпштат "поладомс эди нардамс" пунять лангс.',
	'coll-suggested_articles' => 'Кочкамат',
	'coll-suggest_reset_bans' => 'валхтомс',
	'coll-suggest_reset_bans_tooltip' => 'Няфтемс сядынголе нардаф кочкаматне',
	'coll-suggest_add_selected' => 'Поладомс кочкаф лопатне',
	'coll-suggest_ban_selected' => 'Наодамс кочкаф лопатне',
	'coll-suggest_your_book' => 'Китапце',
	'coll-suggest_show' => 'няфтемс',
	'coll-suggest_ban_tooltip' => 'Нардамс лопать кочкаматнень лувомастост',
	'coll-suggest_article_ban' => 'Лопась <strong>$1</strong> нардафоль кочкамаста ($2).',
	'coll-suggest_article_add' => 'Лопась <strong>$1</strong> полатфоль китапсот ($2).',
	'coll-suggest_article_remove' => 'Лопась <strong>$1</strong> нардафоль китапстот ($2).',
	'coll-suggest_undo_tooltip' => 'Мърдафтомс тя тиемать',
	'coll-suggest_undo' => 'мърдафтомс',
	'coll-load_local_book' => 'Люпштак OK сяда тов покаманди %TITLE% китапцень мархта, конать эса %NUMPAGES% вики лопат. Люпштак Валхтомс тянь нардаманди ди од шава китап мархта ушедоманди.',
	'coll-format-rl' => 'e-китап (PDF)',
	'coll-format-epub' => 'e-китап (EPUB)',
	'coll-format-odf' => 'word процессор (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
	'right-collectionsaveasuserpage' => 'Ванфтомс китапт кода тиить лопанза',
	'right-collectionsaveascommunitypage' => 'Ванфтомс китапт кода пуромсконь лопац',
);
...
$messages['mk'] = array(
	...
	'coll-collection' => 'Книга',
	'coll-collections' => 'Книги',
	'coll-exclusion_category_title' => 'Изземи при печатење',
...
$messages['ml'] = array(
	...
	'coll-book_creator_disable_text' => "''പുസ്തക സൃഷ്ടി ഉപകരണം'' പ്രവർത്തനരഹിതമാക്കുകയും, താങ്കൾ ചെയ്തുകൊണ്ടിരിക്കുന്ന പുസ്തകം നീക്കംചെയ്യുകയും ചെയ്യുന്നതാണ്.",
...
<a href="$1">പുനർ-റെൻഡറിങ് ചെയ്യുക.</a></li></ul>',
	...
	'coll-return_to_collection' => '<p><a href="$1">$2</a> എന്ന താളിലേയ്ക്ക് മടങ്ങുക</p>',
	...
	'coll-about_pp' => '$1 വിവരണം',
	'coll-invalid_podpartner_title' => 'അസാധുവായ ആവശ്യപ്പെട്ടാൽ-അച്ചടിച്ചു-തരുന്ന പങ്കാളി',
...
ചേർക്കാനോ നീക്കംചെയ്യാനോ ഉള്ള ബട്ടണുകൾ ഞെക്കുമ്പോൾ പട്ടിക പുതുക്കപ്പെടുന്നതാണ്.',
	...
	'coll-suggest_undo' => 'തിരസ്കരിക്കുക',
	...
	'coll-format-rl' => 'ഇ-പുസ്തകം (പി.ഡി.എഫ്.)',
	'coll-format-epub' => 'ഇ-പുസ്തകം (ഇപബ്)',
	'coll-format-odf' => 'വേഡ് പ്രോസസ്സർ (ഓപ്പൺഡോക്യുമെന്റ്)',
	'coll-format-zim' => 'കിവിക്സ് (ഓപ്പൺസിം)',
	'coll-format-docbook' => 'ഡോക്ബുക്ക്',
	'coll-format-okawix_zeno' => 'ഒകാവിക്സ്',
...
Mungkin ia telah dipadam dan perlu dijanakan semula.',
	...
	'coll-format-rl' => 'e-buku (PDF)',
	'coll-format-epub' => 'e-buku (EPUB)',
	'coll-format-odf' => 'pemproses kata (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
$messages['nds-nl'] = array(
	...
	'coll-unknown_subpage_title' => 'Onbekende onderzied',
	'coll-unknown_subpage_text' => 'Disse onderzied van [[Special:Book|Boek]] besteet niet',
...
U kunt het boek exporteren in verschillende bestandsformaten (bijvoorbeeld PDF of ODF) of een gedrukt exemplaar bestellen.</big>",
	...
	'coll-couldnotremovearticle_msg' => 'De wikipagina kon niet worden verwijderd.',
...
Seznam je posodobljen, ko kliknete na gumbe za dodajanje ali odstranjevanje.',
	...
	'coll-format-odf' => 'urejevalnik besedila (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
Listan uppdateras när du klickar på lägg till- eller ta bort-knappar.',
	...
	'coll-format-rl' => 'e-bok (PDF)',
	'coll-format-epub' => 'e-bok (EPUB)',
	'coll-format-odf' => 'ordbehandlare (OpenDocument)',
	'coll-format-zim' => 'Kiwix (OpenZIM)',
	'coll-format-docbook' => 'DocBook',
	'coll-format-okawix_zeno' => 'Okawix',
...
$messages['sw'] = array(
	...
	'coll-download_title' => 'Pakua',
	'coll-download' => 'Pakua',
	'coll-remove' => 'Ondoa',
	'coll-show' => 'Onyesha',
	'coll-title' => 'Cheo:',
	'coll-contents' => 'Yaliyomo',
	'coll-rename' => 'Badili jina',
	'coll-new_chapter' => 'Ingiza jina la sura mpya',
	'coll-rename_chapter' => 'Ingiza jina lipya la sura',
	'coll-no_such_category' => 'Hakuna jamii kama hiyo',
	...
	'coll-notfound_title' => 'Kitabu hakijapatikana',
	'coll-notfound_text' => 'Ukurasa wa kitabu haukupatikana.',
...
JavaScript இயக்கப்பட்டால் ஒழிய இப்பக்கம் சரியாக வேலை செய்யாது.</strong>',
	...
	'coll-login_to_save' => 'நீங்கள் பின்னைய பயன்பாட்டுக்கு நூல்களைச் சேமிக்க வேண்டுமென்றால், தயவு செய்து [[Special:UserLogin|உள்நுழையுங்கள் அல்லது ஒரு கணக்கை உருவாக்குங்கள்]].',
...
జావాస్క్రిప్ట్ చేతనం చేస్తే తప్ప, ఈ పేజీ సరిగ్గా పనిచెయ్యదు.</strong>',
	...
	'coll-post_failed_title' => 'పోస్ట్(POST) అభ్యర్థన విఫలమైంది',
	'coll-post_failed_msg' => '$1 కు  పోస్ట్(POST) అభ్యర్ధన విఫలమైంది ($2).',
	'coll-mwserve_failed_title' => 'రూపుదిద్దు సేవిక దోషం',
	'coll-mwserve_failed_msg' => 'రూపుదిద్దు సేవకి పై దోషం ఏర్పడింది:<nowiki>$1</nowiki>',
...
మరిన్ని పేజీలు చేర్చలేము.',
	'coll-rendering_title' => 'రూపుదిద్దుట',
	'coll-rendering_text' => '<p><strong>పుస్తకం రూపుదిద్దుతున్నాం, వేచియుండండి.</strong></p>

<p><strong>పురోగతి:</strong> <span id="రూపుదిద్దటంలో పురోగతి">$1</span>% <span id="రూపుదిద్దు స్థతి">$2</span></p>

<p>ఈ పేజీ కొన్ని సెకండ్లకోసారి అయాచితంగా తాజా కావాల్సి ఉంది. 
అలా కాకపోతే, బ్రౌజరు తాజాపరచు బొత్తాన్ని నొక్కండి.</p>',
	'coll-rendering_status' => '<strong>స్థితి:</strong> $1',
	'coll-rendering_article' => '(వికీ పేజీ: $1)',
	'coll-rendering_page' => '  (పేజీ: $1)',
	'coll-rendering_page_info_text_article' => '{{MediaWiki:Coll-helppage}}/పేజీ వివర పాఠ్యాన్ని రూపుదిద్దుట',
	'coll-rendering_collection_info_text_article' => '{{MediaWiki:Coll-helppage}}/సేకరణ వివరాల పాఠ్యాన్ని రూపుదిద్దుట',
...
<a href="$1">మళ్ళీ రెండరింగు చెయ్యాలని ఫోర్సు చెయ్యి.</a></li></ul>',
	...
	'coll-book_text' => 'ముద్రించిన పుస్తకాన్ని మా ముద్రణ భాగస్వామి నుండి పొందండి',
	'coll-order_from_pp' => '$1 తో మునుజూపు',
	'coll-about_pp' => '$1 గురించి',
	'coll-invalid_podpartner_title' => 'సరైన POD భాగస్వామి కాదు',
	'coll-invalid_podpartner_msg' => ' మీరు  ప్రవేశపెట్టిన అడిగినప్పడు ముద్రించే భాగస్వామి  వివరం సరికాదు.
మీ మీడియావికీ నిర్వహాకులను సంప్రదించండి',
	...
	'coll-suggest_intro_text' => 'సలహాల మీ పుస్తకంలో ప్రస్తుత వికీపేజీలపై ఆధారపడినవి. ఈ జాబితా మీరు 
కలుపు మరియు తొలగించు బొత్తాములను నొక్కినపుడు తాజాపరచబడుతుంది.',
 ...
 */
$messages['ur'] = array(
	'coll-desc' => '[[Special:Book|تخلیق کتب]]',
	'coll-book_creator_intro' => '<big>کتاب تخلیق کار کے ذریعہ آپ اپنی پسند سے ویکی صفحات پر مشتمل کتاب تخلیق کرسکتے ہیں۔ آپ اپنی کتاب کو مختلف شکلبند (مثلاً PDF یا ODF) میں برآمد کرسکتے ہیں یا مطبوعہ نسخہ طلب کرسکتے ہیں۔</big>',
	'coll-manage_your_book' => 'اپنی کتاب کا انتظام کریں',
	'coll-book_creator_help' => 'مزید معلومات کے لیے [[{{MediaWiki:Coll-helppage}}|کتابوں سے متعلق معاونت کا صفحہ]] ملاحظہ کریں۔',
	'coll-start_book_creator' => 'کتاب تخلیق کار شروع کریں',
	'coll-book_creator_continue' => 'کتاب تخلیق کار کے استعمال کو جاری رکھیں',
	'coll-book_creator_disable_text' => 'کتاب تخلیق کار غیر فعال ہوجائے گا اور زیر تخلیق کتاب ختم ہوجائے گی۔',
	'coll-book_creator_text_article' => '{{MediaWiki:Coll-helppage}}/متن برائے کتاب تخلیق کار',
	'coll-collection' => 'کتاب',
	'coll-collections' => 'کتب',
	'coll-exclusion_category_title' => 'خارج از طباعت',
	'coll-print_template_prefix' => 'پرنٹ کریں',
	'coll-print_template_pattern' => '$1/طباعت',
	'coll-unknown_subpage_title' => 'نامعلوم ذیلی صفحہ',
	'coll-unknown_subpage_text' => '[[Special:Book|کتاب]] کا ذیلی صفحہ موجود نہیں ہے',
	'coll-couldnotaddarticle_title' => 'ویکی صفحہ کا اضافہ نہیں کیا جاسکا',
	'coll-couldnotaddarticle_msg' => 'ویکی صفحہ کا اضافہ نہیں کیا جاسکا۔',
	'coll-couldnotremovearticle_title' => 'ویکی صفحہ کو ہٹایا نہ جاسکا',
	'coll-couldnotremovearticle_msg' => 'ویکی صفحہ کو ہٹایا نہ جاسکا۔',
	'coll-noscript_text' => '<h1>جاوا اسکرپٹ درکار!</h1>
<strong>آپ کا متصفح (browser) جاوا اسکرپٹ کو معاونت فراہم نہیں کرتا یا جاوا اسکرپٹ فعال نہیں ہے۔
یہ صفحہ درست طور پر کام نہیں کرے گا، جب تک جاوا اسکرپٹ فعال نہ ہوجائے۔</strong>',
	'coll-savedbook_template' => 'محفوظ_کتاب',
	'coll-your_book' => 'آپ کی کتاب',
	'coll-download_title' => 'زیراثقال',
	'coll-download_text' => 'اپنی کتاب زیراثقال کرنے کے لیے شکلبند منتخب کریں اور زریہ پر طق کریں۔',
	'coll-download_as_text' => '$1 شکلبند میں اپنی کتاب زیراثقال کرنے کے لیے زریہ پر طق کریں۔',
	'coll-download' => 'ڈاؤن لوڈ ، اتارنا',
	'coll-format_label' => 'فارمیٹ:',
	'coll-remove' => 'حذف کریں',
	'coll-show' => 'شو',
	'coll-move_to_top' => 'اوپر جائیں',
	'coll-move_up' => 'اوپر جائیں',
	'coll-move_down' => 'تھوڑا نیچے جائیں',
	'coll-move_to_bottom' => 'نیچے جائیں',
	'coll-title' => 'عنوان:',
	'coll-subtitle' => 'ذیلی ٹائٹل:',
	'coll-contents' => 'مشمولات',
	'coll-drag_and_drop' => 'ویکی صفحات اور ابواب طلب کرنے کے لیے گھسٹ و ٹپک (drag & drop) استعمال کریں',
	'coll-create_chapter' => 'باب تخلیق کریں',
	'coll-sort_alphabetically' => 'ابجدی ترتیب',
	'coll-rename' => 'نیا نام دیں',
	'coll-new_chapter' => 'نئے باب کے لیے نام تحریر کریں',
	'coll-rename_chapter' => 'باب کے لیے نیا نام تحریر کریں',
	'coll-no_such_category' => 'اس طرح کا زمرہ نہیں',
	'coll-notitle_title' => 'صفحہ کے عنوان کی تحدید نہیں کی جاسکی۔',
	'coll-post_failed_title' => 'POST درخواست ناکام',
	'coll-post_failed_msg' => 'POST درخواست برائے $1 ناکام ($2)۔',
	'coll-mwserve_failed_title' => 'خطا از معیل',
	'coll-error_reponse' => 'خطا در تجاوب از معیل',
	'coll-empty_collection' => 'خالی کتاب',
	'coll-revision' => 'اعادہ: $1',
	'coll-save_collection_title' => 'اپنی کتاب کو محفوظ کریں اور حصہ لگائیں',
	'coll-save_collection_text' => 'اپنی کتاب کو محفوظ کرنے کے لیے جگہ منتخب کریں:',
	'coll-login_to_save' => 'اگر آپ بعد میں استعمال کے لیے کتابیں محفوظ کرنا چاہتے ہیں تو براہ کرم [[Special:UserLogin|داخل نوشتہ ہوجائیں یا کھاتہ تخلیق کریں]]۔',
	'coll-personal_collection_label' => 'ذاتی کتاب:',
	'coll-community_collection_label' => 'عمومی کتاب:',
	'coll-save_collection' => 'کتاب محفوظ کریں',
	'coll-save_category' => 'تمام محفوظ کتابیں زمرہ [[:Category:{{MediaWiki:Coll-bookscategory}}|{{MediaWiki:Coll-bookscategory}}]] میں شامل کی جاتی ہیں۔',
	'coll-overwrite_title' => 'صفحہ موجود ہے۔
برتحریر کریں؟',
	'coll-overwrite_text' => 'صفحہ بنام [[:$1]] پہلے سے موجود ہے۔
کیا آپ اپنی کتاب کے ذریعہ اسے تبدیل کرنا چاہتے ہیں؟',
	'coll-yes' => 'جی ہاں',
	'coll-no' => 'نہیں',
	'coll-load_overwrite_text' => 'بعض صفحات آپ کی کتاب میں پہلے سے موجود ہیں۔
کیا آپ اپنی حالیہ کتاب کو برتحریر، جدید مواد کا اضافہ یا اس کتاب کی تحمیل منسوخ کرنا چاہتے ہیں؟',
	'coll-overwrite' => 'برتحریر',
	'coll-append' => 'انتظار',
	'coll-cancel' => 'منسوخ',
	'coll-update' => 'اپ ڈیٹ',
	'coll-limit_exceeded_title' => 'کتاب بہت بڑی ہے',
	'coll-limit_exceeded_text' => 'کتاب بہت بڑی ہے۔
مزید صفحات شامل نہیں کیے جاسکتے۔',
	'coll-rendering_status' => '<strong>حالت:</strong> $1',
	'coll-rendering_article' => '(ویکی صفحہ: $1)',
	'coll-rendering_page' => '(صفحہ: $1)',
	'coll-notfound_title' => 'کتاب موجود نہیں',
	'coll-notfound_text' => 'کتاب کا صفحہ مل نہیں سکا۔',
	'coll-download_notfound_title' => 'ملف موجود نہیں',
	'coll-download_notfound_text' => 'جس ملف کو آپ زیراثقال کرنے کی کوشش کررہے ہیں وہ موجود نہیں ہے:
ممکن ہے وہ حذف ہوچکی ہو یا اس کی از سر نو تخلیق درکار ہو۔',
	'coll-download_failed_title' => 'خطا اثناء زیراثقال',
	'coll-download_failed_text' => 'ملف: $1 کے زیراثقال کے دوران خطا واقع ہوئی',
	'coll-excluded-templates' => '* اس زمرہ [[:Category:$1|$1]] میں موجود سانچہ جات خارج کردیے گئے۔',
	'coll-blacklisted-templates' => 'سیاہ فہرست [[:$1]] میں موجود سانچہ جات خارج کردیے گئے۔',
	'coll-return_to_collection' => '<p>واپس <a href="$1">$2</a></p>',
	'coll-book_title' => 'طلب بطور مطبوعہ کتاب',
	'coll-book_text' => 'ہمارے شریک برائے طباعت بوقت طلب سے مطبوعہ نسخہ حاصل کریں۔',
	'coll-order_from_pp' => 'نمائش مع $1',
	'coll-about_pp' => '$1 کے متعلق',
	'coll-invalid_podpartner_title' => 'POD شریک غیر صحیح',
	'coll-invalid_podpartner_msg' => 'فراہم کردہ POD شریک درست نہیں ہے۔
براہ کرم اپنے میڈیاوکی منتظمین سے رابطہ کریں۔',
	'coll-license' => 'اجازہ',
	'coll-return_to' => 'واپس [[:$1]]',
	'coll-order_info_article' => '{{MediaWiki:Coll-helppage}}/ معلومات برائے طلب از پیڈیاپریس',
	'coll-suggest_title' => 'آپ کی کتاب کے مجوزہ صفحات',
	'coll-suggested_articles' => 'تجاویز',
	'coll-suggest_reset_bans' => 'دوبارہ مرتب کریں',
	'coll-suggest_reset_bans_tooltip' => 'سابقہ زائل شدہ تجاویز دکھائیں',
	'coll-suggest_add_selected' => 'منتخب صفحات شامل کریں',
	'coll-suggest_ban_selected' => 'منتخب صفحات ہٹائیں',
	'coll-suggest_your_book' => 'آپ کی کتاب',
	'coll-suggest_show' => 'شو',
	'coll-suggest_ban_tooltip' => 'فہرست تجاویز سے اس صفحہ کو ہٹائیں',
	'coll-suggest_article_ban' => 'صفحہ <strong>$1</strong> تجاویز سے ہٹا دیا گیا ($2)۔',
	'coll-suggest_article_add' => 'صفحہ <strong>$1</strong> آپ کی کتاب میں شامل کردیا گیا ($2)۔',
	'coll-suggest_article_remove' => 'صفحہ <strong>$1</strong> آپ کی کتاب سے ہٹا دیا گیا ($2)۔',
	'coll-suggest_undo_tooltip' => 'اس اقدام کا استرجع',
	'coll-suggest_undo' => 'استرجع',
	'coll-format-rl' => 'برقی کتاب (PDF)',
	'coll-format-epub' => 'برقی کتاب (EPUB)',
	'coll-format-zim' => 'کیوکس (OpenZIM)',
	'coll-format-okawix_zeno' => 'اوکاوکس',
	'right-collectionsaveasuserpage' => 'بطور صفحہ صارف کتابیں محفوظ کریں',
...
$messages['zh-hans'] = array(
	...
	'coll-book_creator_intro' => "<big>使用''图书创建器''，你可以创建包含你选择的维基页面的图书。你可以以不同格式（如PDF、ODF）导出你的图书或订购印刷图书。</big>",
	...
	'coll-couldnotaddarticle_title' => '无法添加维基页面',
	'coll-couldnotaddarticle_msg' => '本维基页面无法添加。',
	'coll-couldnotremovearticle_title' => '无法删除维基页面',
	'coll-couldnotremovearticle_msg' => '本维基页面无法删除。',
	'coll-noscript_text' => '<h1>需要JavaScript！</h1><strong>你的浏览器不支持JavaScript或未启用JavaScript。在启用JavaScript前，本页面无法正常工作。</strong>',
	'coll-savedbook_template' => '已保存的图书',
	'coll-your_book' => '你的图书',
	'coll-download_title' => '下载',
	'coll-download_text' => '请选择格式并单击按钮下载你的图书。',
	'coll-download_as_text' => '请单击按钮，以$1格式下载你的图书。',
	'coll-download' => '下载',
	'coll-format_label' => '格式：',
	'coll-remove' => '删除',
	'coll-show' => '显示',
	'coll-move_to_top' => '移至顶部',
	'coll-move_up' => '上移',
	'coll-move_down' => '下移',
	'coll-move_to_bottom' => '移至底部',
	'coll-title' => '标题：',
	'coll-subtitle' => '副标题：',
	'coll-contents' => '目录',
	'coll-drag_and_drop' => '请用鼠标拖拽以改变维基页面和章节的顺序',
	...
	'coll-overwrite_title' => '页面已存在。是否覆盖？',
	'coll-overwrite_text' => '名为[[:$1]]的页面已存在。你想让你的图书替代它吗？',
	'coll-yes' => '是',
	'coll-no' => '否',
	'coll-load_overwrite_text' => '你的图书中已有页面。你想要覆盖你现在的图书、增补新内容还是取消载入本图书？',
	'coll-overwrite' => '覆盖',
	'coll-append' => '增补',
	'coll-cancel' => '取消',
	'coll-update' => '更新',
	...
	'coll-download_notfound_text' => '你正在尝试下载的文件不存在：可能该文件已被删除，需要重新生成。',
	'coll-download_failed_title' => '下载出错',
	'coll-download_failed_text' => '下载该文件时出错：$1',
	'coll-is_cached' => '<ul><li>发现该文件的缓存版本。不需要重新生成该文件。<a href="$1">强制重新生成。</a></li></ul>',
	'coll-excluded-templates' => '*已排除[[:Category:$1|$1]]分类中的模板。',
	'coll-blacklisted-templates' => '*已排除黑名单[[:$1]]上的模板。',
	'coll-return_to_collection' => '<p>返回<a href="$1">$2</a></p>',
	...
	'coll-suggest_intro_text' => '建议列表基于你的图书中现有的wiki页面。本列表将在你单击“添加”或“删除”按钮后更新。',
	'coll-suggested_articles' => '建议',
	'coll-suggest_reset_bans' => '重置',
	'coll-suggest_reset_bans_tooltip' => '显示以前删除的建议',
	'coll-suggest_add_selected' => '添加选择的页面',
	'coll-suggest_ban_selected' => '删除选择的页面',
